...
// ValidateTestItemCreateRequest validates the create request
func ValidateTestItemCreateRequest(req *models.CreateTestItemRequest) error {
	...
	// if req.Email != "" && (len(req.Email) < MinLength || len(req.Email) > MaxLength) {
	// 	validationErrors.AddError("Email must be between %d and %d characters", MinLength, MaxLength)
	// }
...
// ValidateTestItemUpdateRequest validates the update request
func ValidateTestItemUpdateRequest(req *models.UpdateTestItemRequest, id uint) error {
	// Initialize validation errors collection
	validationErrors := &ValidationErrors{}
...
// ValidateTestItemDeleteRequest validates the delete request
func ValidateTestItemDeleteRequest(id uint) error {
	// Initialize validation errors collection
	validationErrors := &ValidationErrors{}
